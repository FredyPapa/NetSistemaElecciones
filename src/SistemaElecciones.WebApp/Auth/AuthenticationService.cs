...
namespace SistemaElecciones.WebApp.Auth;
...
public class AuthenticationService : AuthenticationStateProvider
{
    ...
    {
        //Esta es la representación del usuario autenticado
    ...
    public override async Task<AuthenticationState> GetAuthenticationStateAsync()
    {
        ...
        var claimsPrincipal = new ClaimsPrincipal(new ClaimsIdentity(ParseToken(sesionUsuario).Claims,authenticationType:"JWT"));
